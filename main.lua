...
local KC_HALLS = {
  ...
  ECRUTEAK = {
    ...
    -- STARTER ROOM (0.34.38). Goldenrod's stage copied over, so
    -- Ecruteak has a VALID stage the moment it registers -- and the
    -- SAME 5x7 geometry, so every cell the cast code depends on
    -- already lines up: coordinators at (4,8) (5,8) (6,8), the
    -- player's mark at (4,6), the line-up at (3,8), the thirty
    -- audience seats, and the carpet exit at (4,13)/(5,13).
    -- Repaint it in the Content Editor and it reads back the way the
    -- Ecruteak facade did; keep those cells where they are or the
    -- cast tables have to move with them. Until then the art is
    -- MART-derived, which is why it still looks like Goldenrod's.
    stage = {
